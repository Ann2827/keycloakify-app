...
const LoginUpdateProfile = ({
  ...
  theme,
  ...props
}: { kcContext: KcContextBase.LoginUpdateProfile } & KcProps & { theme: ThemeTypes }) => {
  ...
  const formNode = (
    <form id='kc-update-profile-form' className={cx(props.kcFormClass)} action={url.loginAction} method='post'>
      ...
      <div
        className={cx(props.kcFormGroupClass, messagesPerField.printIfExists('firstName', props.kcFormGroupErrorClass))}
      >
        <div className={cx(props.kcLabelWrapperClass)}>
      ...
      <div
        className={cx(props.kcFormGroupClass, messagesPerField.printIfExists('lastName', props.kcFormGroupErrorClass))}
      >
        <div className={cx(props.kcLabelWrapperClass)}>
...
export default React.memo(LoginUpdateProfile);
